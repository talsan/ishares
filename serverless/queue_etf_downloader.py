...
def lambda_handler(event, context):
    event_dict = {'etf_list': ['IWV', 'ACWI', 'IVV', 'IWB', 'IWM','ACWX'], 'overwrite': False}
    ...
    for ticker in event_dict['etf_list']:
        ...
        #         FunctionName="ishares-dev-etf_downloader",
        #         InvocationType='Event',
        #         Payload=json.dumps({'etf': ticker, 'holdings_date': holding_date})
        #     )

        for holding_date in holdings_download_list:
            output['etf_holding_pairs'].append({'etf': ticker, 'holdings_date': holding_date})
